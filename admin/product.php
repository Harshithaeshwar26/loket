...
// echo $product_name;
// print_r($_POST);
$sql = "INSERT INTO admin_product(product_id, product_name, initial_cost,final_cost, product_quantity, product_code,sub_category_name,category_name,shop_id,colour, size, height, weight, depth,offer_code, total_tax) VALUES (NULL, '$product_name','$initial_cost','$final_cost', '$product_quantity','$product_code','$sub_category_name','$category_name','$shop_id','$colour','$size','$height','$weight','$depth','$offer_code','$total_tax');"; 
