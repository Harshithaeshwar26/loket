                    ...
                    <div class="main-menu-block">
                        ...
                        <div class="menu-right">
                            ...
                            <div>
                                <div class="icon-nav">
                                    <ul>
                                        <li class="mobile-user onhover-dropdown"><a href="profile.php"><i class="icon-user"></i></a>
                                        </li>
...
<!--title start-->
<div class="title4 section-my-space text-center  pr--10">
    <h4 class = "text-left pl-3" style = "font-family:'Comic Sans MS', cursive, sans-serif; color: #228b22;">Household </h4><p class = "text-right pr-5"><a  href > View More</a> <span></span></p>
</div>
<h4>
<!--title end-->
...
<div class="title4 section-my-space text-center  pr--10">
    <h4 class = "text-left pl-3 " style = "font-family:'Comic Sans MS', cursive, sans-serif; color: #cf1d27;">Snacks and Beverages</h4><p class = "text-right pr-5"><a  href > View More</a> <span></span></p>
</div>
<h4>
<!--title end-->
...
<div class="title4 section-my-space text-center  pr--10">
    <h4 class = "text-left pl-3" style = "font-family:'Comic Sans MS', cursive, sans-serif; color: #228b22;">Dry Fruits </h4><p class = "text-right pr-5"><a  href > View More</a> <span></span></p>
</div>
<h4>
<!--title end-->
                    ...
                    while($row=$result->fetch_assoc()){
                        ...
                        <div class="product-box ">
                            ...
                            <div class="addtocart_btn">';
                                ...
                                echo '<button class="add-button" style = "background-color:#ffc30b"> <a class="addtocart_btn" href="checkout.php?id='.$product_name.'" style="color:black">Buy Now</a>
...
<div class="title4 section-my-space text-center  pr--10">
    <h4 class = "text-left pl-3" style = "font-family:'Comic Sans MS', cursive, sans-serif; color: #cf1d27;">Hair Care Essentials </h4> <p class = "text-right "><p class = "text-right pr-5"><a  href > View More</a> <span></span></p>
</div>
<h4>
<!--title end-->
...
<div class="title4 section-my-space text-center  pr--10">
    <h4 class = "text-left pl-3" style = "font-family:'Comic Sans MS', cursive, sans-serif; color: #228b22;">Baby Care </h4><p class = "text-right pr-5"><a  href > View More</a> <span></span></p>
</div>
<h4>
<!--title end-->
...
<div class="title4 section-my-space text-center  pr--10">
    <h4 class = "text-center pl-3" style = "font-family:'Comic Sans MS', cursive, sans-serif; color: black;">Trending Products </h4><p class = "text-right pr-5"><a  href ></a> <span></span></p>
</div>
<h4>
<!--title end-->
