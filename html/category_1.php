                        ...
                        <div>
                            <div class="slider-banner slide-banner-5 ">
                                <div class="slider-img">
                                    <img src="../assets/images/layout-6/slider/2.1.jpg" class="bg-img  " alt="slider" >
                            ...
                            <div class="slider-banner slide-banner-5">
                                <div class="slider-img">
                                    <ul class="layout6-slide-1">
                                        <li id="img-1"><img src="../assets/images/layout-6/slider/1.1.png" class="img-fluid" alt="slider"></li>
                                    </ul>
                                </div>
                                <div class="slider-banner-contain">
                                    <div >
